          ...
          <div className="container max-w-4xl mx-auto px-4 py-8 md:py-12">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <section aria-label="What Is HRDC and Who Needs to Register?" className="mb-8">
                ...
                <p className="text-muted leading-relaxed mb-4">
                  Employers with 50 or more employees are required to register and contribute to the HRDC levy. Employers with 10 to 49 employees may register voluntarily and access the same benefits, including grant claims for approved training programs.
                </p>
                <p className="text-muted leading-relaxed">
                  Once registered, employers contribute a monthly levy based on their total employee wages. These contributions accumulate in a levy account that can be used to claim training grants when employees attend approved training programs.
                </p>
              </section>
